...
if ( $playlist && ! empty( $playlist['videos'] ) ) :
	...
	?>
<div class="bsp-wrapper <?php echo esc_attr( $atts['class'] ) ?> layout-<?php echo $layout; ?>">
	<?php
					...
					<li class="bsp-videos-item <?php if ( ! $_video_index )
						...
						<a href="#" class="bsp-clearfix bsp-item" data-video-id="<?php echo $video_ID ?>">
							...
							<span class="bsp-video-info">
								...
								<span class="bsp-small bsp-video-duration"><?php echo bsp_get_video_duration( $video_info['duration'] ) ?></span>
							</span>
						</a>
					</li>
				<?php endforeach ?>
