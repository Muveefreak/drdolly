		...
		<section class="review-cons-pros clearfix">
			<?php if ( $pros ) { ?>
				<aside class="review-pros-section">
					...
					<h5 class="heading"><i class="bf-icon fa fa-check"></i> <?php the_better_review_pros_heading(); ?>
					</h5>
			...
			<?php if ( $cons ) { ?>
				<aside class="review-cons-section">
					...
					<h5 class="heading"><i class="bf-icon fa fa-times"></i> <?php the_better_review_cons_heading(); ?>
					</h5>
